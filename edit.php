...
<form method="post" action="editrecord.php">
    ...
    <div class="mb-3">
        ...
        <input type="email" value="<?php echo $attendee['email'] ?>" class="form-control" for="email" id="email"
    ...
    <div class="mb-3">
        ...
        <input type="text" value="<?php echo $attendee['contactnum'] ?>" name="contactnum" class="form-control"
            id="contactnum" aria-describedby="phoneHelp">
